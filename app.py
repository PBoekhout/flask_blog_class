...
def create():
    #determine if the page is beign requested with a post or GET request
    if request.method == 'POST':
        title = request.form['title']
        content = request.form['content']

        #display an error if title or content is not submitted
        #else make a database connection and insert the blog ccontent
        if not title:
...
#create a route to edit the post. Load page with get or post method
#pass the post id as a url paramater
